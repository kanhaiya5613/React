...
function App() {
  ...
  return (
    <div className='className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500 bg-gray-700"'>
      ...
      <div className='flex text-sm gao-x-2'>
